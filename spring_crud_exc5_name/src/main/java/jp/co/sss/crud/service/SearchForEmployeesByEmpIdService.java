...
public class SearchForEmployeesByEmpIdService {
	 ...
	 */
	//TODO ここに記述
	public EmployeeRepository reository;
	...
	public EmployeeBean execute(Integer empId) {
		...
		// という、ByDepartmentクラスと同じような文章なのに、EmployeeRepositoryクラスを見に行ってもなかった理由は
		// (1件だけの)主キー検索のためSpringが標準で用意してくれるため。
		Employee employee = new Employee();
		employee = reository.getReferenceById(empId);
		
		// BeanManagerを使用してEmployeeBeanに変換して返却します。
		// ○○を変換してと書かれていたら、左側 → 戻り値を入れる変数を書く、右側 → 変換メソッドを使う

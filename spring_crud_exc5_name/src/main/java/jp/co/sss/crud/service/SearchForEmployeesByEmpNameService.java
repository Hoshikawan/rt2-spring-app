...
public class SearchForEmployeesByEmpNameService {
	...
	public List<EmployeeBean> execute(String searchString){
		List<Employee> employee = repository.findByEmpNameContainingOrderByEmpId(searchString);
		List<EmployeeBean> empBeans = BeanManager.copyEntityListToBeanList(employee);
		return empBeans;
